...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/@superset-hq/browser-image-compression@2.0.2/dist/browser-image-compression.js"></script>
```
...
const options: Options = { 
  ...
  libURL: string,               // optional, the libURL of this library for importing script in Web Worker (default: https://cdn.jsdelivr.net/npm/@superset-hq/browser-image-compression/dist/browser-image-compression.js)
